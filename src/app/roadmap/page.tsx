      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 dark:bg-blue-500/20 border border-blue-500/20 mb-6 animate-fadeIn">
            ...
            <span className="text-sm font-medium text-blue-700 dark:text-blue-300">Product Roadmap 2025</span>
          </div>
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto animate-slideUp" style={{ animationDelay: '100ms' }}>
...
const ROADMAP_ITEMS = [
  ...
  },
  {
    ...
    description: "Verified local builder connections for real-time quote validation and booking. Get three quotes automatically.",
  ...
  },
  {
    ...
    description: "Recent sales data combined with local indices for more accurate post-refurb valuations. Confidence scoring included.",
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" strokeLinecap="round" strokeLinejoin="round" /></svg>,
    status: "Q2 2025",
    benefits: ["Sales data", "Confidence bands"],
  },
  {
    title: "Off-market sourcing",
    description: "Probate, distressed sales, and stale listings—identified and tracked automatically with automated outreach workflows.",
  ...
  },
  {
    ...
    description: "Investment view and Management view for tracking multiple properties and performance metrics with real-time updates.",
  ...
  },
  {
    ...
    description: "Extracts signals like 'needs modernisation', 'no heating', 'chain-free' to adjust estimates and flag opportunities.",
  ...
  },
  {
    ...
    description: "Low–mid–high bands for all estimates, based on data quality and local coverage. Transparent methodology shown.",
  ...
  },
  {
    ...
    description: "Your edits and corrections fine-tune models for your postcodes and deal types. Personal AI assistant that learns.",
  ...
  },
  {
    ...
    description: "Generate post-refurb visual renders to show clients the potential. Before/after comparisons automatically.",
    ...
    status: "2026",
    benefits: ["Visual renders", "Client wow"],
  },
  {
    title: "Smart agent automation",
    description: "Auto-email or voice outreach for missing data, viewings, and follow-ups. Conversational AI that sounds human.",
  ...
  },
  {
    ...
    description: "Chat commands trigger recalculations and live updates—interact naturally with your data. Voice commands supported.",
