...
export default function HowItWorksPage() {
        ...
        <div className="container space-y-10">
          <header>
            ...
            <p className="small mt-1 text-slate-600">
              A compressed, auditable pipeline from link → structured data → refurbishment & rent modelling → full financials → shareable export.
            </p>
          </header>
          ...
          <section className="card p-6">
            ...
            <p className="small text-slate-700 mt-2">
              We classify each image, infer room type and visible condition, then map to a bill-of-quantities template with regional trade rates.
              You can override line items, add contingencies, and lock figures once quotes arrive.
            </p>
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="rounded-xl border p-4">
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  ...
                  <li>Condition cues (cabinet age, tile wear, damp marks, electrics)</li>
                </ul>
              </div>
              <div className="rounded-xl border p-4">
                <div className="font-medium">Line-item mapping</div>
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  <li>Template scope per room (paint, flooring, fixtures, partial rewire)</li>
                  <li>Postcode-based cost indices and labour assumptions</li>
                </ul>
              </div>
              <div className="rounded-xl border p-4">
                <div className="font-medium">Confidence & controls</div>
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  <li>Per-room confidence banding; flag for manual check on low quality</li>
          ...
          <section className="card p-6">
            <h3 className="card-title">Financial stack</h3>
            <p className="small text-slate-700 mt-2">
              Transparent inputs, instant recalculation, lender-friendly outputs. Toggle voids, management, maintenance, and leverage.
            </p>
            <div className="mt-3 overflow-x-auto">
              <table className="w-full text-sm border rounded-xl overflow-hidden">
                ...
                <tbody className="divide-y">
                  ...
                  <tr><td className="p-3 font-medium">Leverage</td><td className="p-3">✓</td><td className="p-3">IO/repayment (roadmap for products/ERC)</td></tr>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card p-6">
              <h3 className="card-title">Comps & sanity checks</h3>
              <ul className="small text-slate-700 list-disc pl-5 mt-2 space-y-1">
                ...
                <li>Banding nudges to prompt manual review when needed</li>
              </ul>
            </div>
            <div className="card p-6">
              <h3 className="card-title">EPC enrichment</h3>
              <ul className="small text-slate-700 list-disc pl-5 mt-2 space-y-1">
                <li>Rating & recommended measures where available</li>
                <li>Full record stored for reporting and audit</li>
              </ul>
            </div>
          </section>
  ...
  const FLOW = [
    { title: "Paste a URL", desc: "Agent/auction and compatible pages → clean, structured fields.", icon: IconList() },
    { title: "We fetch & compute", desc: "Refurb from photos, rent/value checks, fees and ROI.", icon: IconPlus() },
